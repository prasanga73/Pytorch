...
from modelarch import CustomCNN  # Import your model architecture
model = CustomCNN(num_classes=7)
model.load_state_dict(torch.load("models/modeldrop4.pth", map_location=torch.device('cpu'), weights_only=True))
